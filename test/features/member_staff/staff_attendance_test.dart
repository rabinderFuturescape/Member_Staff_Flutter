...
import 'package:member_staff_app/src/features/member_staff/services/photo_uploader.dart';
...
@GenerateMocks([AttendanceService, PhotoUploader])
void main() {
  late MockAttendanceService mockAttendanceService;
  late MockPhotoUploader mockPhotoUploader;
  ...
  setUp(() {
    ...
    // Setup default mocks
    when(mockPhotoUploader.captureAndUploadPhoto())
